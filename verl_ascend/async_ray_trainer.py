...
from verl.trainer.ppo import core_algos, compute_advantage
...
class AsyncRayPPOTrainer(RayPPOTrainer):
    ...
    def __init__(
        ...
        def _validate_config(self):
            ...
            if config.actor_rollout_ref.actor.strategy == "megatron":
                ...
                assert (
                    n_gpus_actor % (model_parallel_size * config.actor_rollout_ref.actor.megatron.context_parallel_size) == 0
                ), (
                    f"n_gpus_actor ({n_gpus_actor}) must be divisible by model_parallel_size ({model_parallel_size}) times "
    ...
    def init_workers(self):
        ...
        self.rollout_wg.set_ctor_weights_info(weights_info)
        ...
        if self.config.actor_rollout_ref.rollout.mode == "async" and self._is_rollout:
            from verl.workers.rollout.aysnc_server import AsyncLLMServerManager
